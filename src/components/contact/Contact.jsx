        ...
        <Box>
            ...
            <Box className={classes.wrapper}>
                ...
                <Typography variant="h5" className={classes.text}>
                    Reach out to me on
                    <Link href="https://www.instagram.com/apathare9/" color="inherit" target="_blank">
                        <Instagram/>
                    </Link>
                    or send me an Email 
                    <Link href="mailto:ajinkyapathare@outlook.com?Subject=This is a subject" target="_blank" color="inherit">
                        <Email />
                    </Link>.
                </Typography>
            </Box>
